...
def cpu_process_usage(string):
    while True:
        print(lib.cpuProcessUsage(ctypes.c_char_p(string.encode('utf-8'))))


# cpu_process_usage(psutil.Process(21488).name()[:-4])
print(psutil.Process(22480))
